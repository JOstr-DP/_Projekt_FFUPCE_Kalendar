...
class EventCreateForm(forms.ModelForm):
	"""Formular pro vytvoreni a editaci akce."""

	teacher_name = forms.CharField(
		label='Teacher',
		max_length=120,
		help_text='Zacnete psat jmeno a vyberte existujiciho ucitele z databaze.',
	...
	def __init__(self, *args, **kwargs):
		...
		self.teacher_name_choices = list(Teacher.objects.order_by('name').values_list('name', flat=True))
